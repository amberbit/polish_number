...
describe :PolishNumber do
  {
      ...
      5123754321 => {:number => 'pięć miliardów sto dwadzieścia trzy miliony siedemset pięćdziesiąt cztery tysiące trzysta dwadzieścia jeden', :PLN => 'złotych', :cents_digital => '00/100', :cents_word => 'zero', :PLN_100 => 'groszy'}
